  ...
  return (
    <>
      ...
      <div className="@apply border-[#D8D8D8]">
        ...
        <div className="  @apply w-[961px] h-[340px] gap-0  absolute left-[108px] top-[1179.17px]">
      ...
      <div
        className="  @apply w-[1440px] h-[344px] gap-0  absolute top-[1653px]"
        style={{
      ...
      <div className="  @apply w-[1440px] h-[810px] gap-10  bg-white absolute top-[1990px]">
      ...
      <div className="@apply w-[1440px] h-[568px] gap-6  absolute px-[108px] py-20 top-[2770px] bg-myColor">
