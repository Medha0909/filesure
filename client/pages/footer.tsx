...
function Footer() {
  return (
    <>
    <div className="  @apply w-[1224px] h-[311px] gap-10 bg-[#111111] shadow-[0px_2px_24px_0px_#00000014] absolute pt-6 pb-0 px-0 rounded-[12px_12px_12px_12px] left-[100px] top-[4000px]">
      <img className="@apply w-[290px] h-[290px] top-[-60px] absolute gap-0 left-[500px]" src="https://s3-alpha-sig.figma.com/img/0b29/5d18/447030ac981738d1de0668b277e646ce?Expires=1722816000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=RJHTG36SihUChvsQGzAhReIaW9Mk23cD12OHiHVH371Pi8n3XUpv~D4Lk8liF~8O5p15naqgldM7CgAUmcQlCOtTTwnsOxa0e1EERny3LCLqIYYAIwwaPpNifANWvQlWAr-9NcUSt8zXcuUx-u6Te78hHWftBfigh5HNCwb8ZlL9kt4eAgReKHy4EEpPqxGGnQ5xh9fTtbQWwGmGrSJX-TnWHrFR1mK8518N-R7UhRBTQ27FZUZCxrKQ3ALVT51OrW8YZMGfLfAQDRF8xbiCuhvv91ky5~osfYMo8KB9uFrEJl-KeS5vnngJbUTF05TdTJeSZuexyQy3rXfTqfvyGg__" alt="footerlogo"></img>
      <div className='  @apply w-[1176px] h-[54px] gap-0 absolute left-[25px] top-[200px]'>
        ...
        <span><HiOutlineDeviceMobile size={24} /></span>
