    ...
    <div className="media bg-myColor">
      ...
      <ul>
        <li>
          ...
          <span className="icon" /> Fitness and spor <span className="icon" />{" "}
          Bank
        </li>
        <li>
          <span className="icon">
      ...
      <span className="project">
        <p>
          ...
          integrating secure
          <br /> login, absence registration, and a tenant notice board.
          Elevating the resident
          <br /> experience with user-friendly design and efficient
